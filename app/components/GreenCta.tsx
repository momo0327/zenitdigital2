...
const GreenCTA = () => {
  return (
    <div className="px-6 md:px-12 lg:px-16 bg-white py-16 md:py-20 lg:py-24">
      <div className="rounded-2xl overflow-hidden min-h-[800px] md:min-h-[900px] lg:min-h-[1000px] relative">
        {/* Green Section - Top Half */}
        <div className="bg-[#051E01] px-8 md:px-12 lg:px-16 py-20 md:py-24 lg:py-32 text-center h-1/2 flex items-center rounded-b-lg">
          <div className="max-w-4xl mx-auto w-full">
            {/* Main Title */}
            <h2 className="text-5xl sm:text-6xl md:text-7xl lg:text-8xl xl:text-9xl font-antonio font-bold text-[#B4FFA8] mb-8">
              Learning like <br /> never before
            </h2>
            {/* Subtitle */}
            <p className="text-sm md:text-xl lg:text-xl text-[#B4FFA8] mb-10 md:mb-8 max-w-xl mx-auto">
            ...
            <div className="flex sm:flex-row gap-4 md:gap-6 justify-center items-center">
              ...
              <button className="border-2 border-[#B4FFA8] text-[#B4FFA8] px-6 py-3 text-sm md:text-md font-medium rounded-full hover:bg-[#B4FFA8] hover:text-green-900 transition-all duration-200 transform hover:scale-105">
                Contact
              </button>
              </Link>
            </div>
