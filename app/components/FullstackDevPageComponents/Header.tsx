      ...
      <div className="bg-[#F4F4F6] rounded-lg px-8 md:px-12 lg:px-16 py-12 md:py-16 lg:py-10 min-h-[600px] md:min-h-[700px] lg:min-h-[800px] flex items-center justify-center">
        ...
        <div className="grid lg:grid-cols-2 gap-8 lg:gap-16 items-center w-full max-w-7xl">
          ...
          <div className="text-white flex flex-col justify-center items-center lg:items-start max-w-8xl">
            <h1 className="text-6xl text-center lg:text-left md:text-6xl lg:text-8xl xl:text-8xl font-antonio font-bold text-[#0558F9]  mb-6">
              Fullstack <br /> Development
            </h1>
                         
            <p className="text-[#0558F9] text-center lg:text-left text-lg md:text-xl lg:text-2xl mb-8 max-w-lg">
              The way we work has changed, but learning software hasnt. 
            </p>
                         
            <div className="flex justify-center lg:justify-start flex-row gap-4">
              <button className="bg-[#0558F9] hover:bg-[#BEA1FC] text-white font-semibold px-4 py-3 text-sm md:px-6 md:py-3 rounded-full md:text-md transition-all duration-300 transform hover:scale-105 shadow-lg">
                Get Started
              </button>
          ...
          <div className="flex justify-center">
            <OptimizedImage
              src="/Group 6-3.png"
              alt="Fullstack development - Complete end-to-end application development from frontend to backend"
              width={600}
              height={700}
