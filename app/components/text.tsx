...
const BigText = () => {
  return (
    <div className="bg-white flex items-center flex-col justify-center py-12 md:py-16 px-4">
      {/* Main heading section */}
      <div className="max-w-7xl mx-auto w-full flex justify-center lg:justify-end">
        <div className="text-left lg:text-left max-w-2xl lg:max-w-none">
          <h1 className="text-3xl sm:text-4xl md:text-5xl lg:text-4xl xl:text-5xl font-medium text-black leading-tight mb-3">
