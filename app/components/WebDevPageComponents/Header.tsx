        ...
        <div className="grid lg:grid-cols-2 gap-8 lg:gap-16 items-center w-full max-w-7xl">
          ...
          <div className="text-white flex flex-col justify-center items-center lg:items-start max-w-8xl">
            ...
            <div className="flex justify-center lg:justify-start flex-row gap-4">
              ...
              <Link href="/ContactPage">
              <button className="border-1 border-[#FF5147] text-[#FF5147] font-semibold md:px-6 md:py-3 rounded-full text-md px-4 py-3 text-sm transition-all duration-300 backdrop-blur-sm hover:bg-[#F5F5F5]/10">
                Learn More
              </button>
              </Link>
            </div>
          ...
          <div className="flex justify-center">
            <OptimizedImage
              src="/Group 6-3.png"
              alt="Web development services showcase - Modern responsive web applications and enterprise solutions"
              width={675}
              height={879}
